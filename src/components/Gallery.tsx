...
import img1 from '../assets/images/BROOK PNG/club.jpg';
import img2 from '../assets/images/swimming_pool2.jpg';
import img3 from '../assets/images/BROOK PNG/high_street.jpg';
import img4 from '../assets/images/jogging_treck.jpg';
import img5 from '../assets/images/basketball.jpg';
import img6 from '../assets/images/BROOK PNG/V7 DAY.jpg';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Experience <span className="font-bold" style={{background: 'linear-gradient(313deg, #8c5438 0%, #c76a43 50%, #f3b79e 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Brook and Revulet</span>
          </h2>
